       ...
       if($_SERVER['REQUEST_METHOD'] == "POST")
       {
       	...
       	if(!empty($email_id) && !empty($password) && !is_numeric($email_id))
       	{
       		...
       		//save to database
       			...
       			$query = mysqli_query($conn,"INSERT INTO admin (user_id, First_Name, Last_Name, Email_Id, Mobile_No, Password) VALUES ('$user_id','$first_name','$last_name','$email_id','$mobile_no','$password')");
