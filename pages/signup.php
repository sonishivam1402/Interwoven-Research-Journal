       ...
       if($_SERVER['REQUEST_METHOD'] == "POST")
       {
       	...
       	if(!empty($email_id) && !empty($password) && !is_numeric($email_id))
       	{
       		...
       		if($role == "reviwer"){
       			...
       			$query = mysqli_query($conn,"INSERT INTO reviewers (user_id, First_Name, Last_Name, Email_Id, Mobile_No, Password, Role) VALUES ('$user_id','$first_name','$last_name','$email_id','$mobile_no','$password','$role')");
